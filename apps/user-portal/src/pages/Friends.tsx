...
export function Friends() {
  ...
  if (state.isLoading) {
    return (
      <div data-testid="friends-page" className="page-container max-w-5xl">
        <h1 className="mb-5 text-3xl font-bold text-slate-900">Friends</h1>
  ...
  return (
    <div data-testid="friends-page" className="page-container max-w-5xl">
      ...
      {state.actionError ? (
        <p data-testid="friends-action-error" className="mb-4 text-sm text-danger-600">
          {state.actionError}
        </p>
      ) : null}

      <section data-testid="friends-accepted-section" className="mb-6">
        <h2 className="mb-3 text-xl font-semibold text-slate-900">My friends</h2>
      ...
      <section data-testid="friends-incoming-section" className="mb-6">
        <h2 className="mb-3 text-xl font-semibold text-slate-900">Incoming requests</h2>
      ...
      <section data-testid="friends-outgoing-section">
        <h2 className="mb-3 text-xl font-semibold text-slate-900">Outgoing requests</h2>
